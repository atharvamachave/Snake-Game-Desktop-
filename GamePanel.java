...
public class GamePanel extends JPanel implements ActionListener{
	...
	public void checkCollisions() {
		...
		//check if head touches bottomborder
	...
	public void gameOver(Graphics g) {
		...
		g.setFont(new Font("Juice ITC",Font.BOLD,50));
		FontMetrics metrics3 = getFontMetrics(g.getFont());
		g.drawString("Better Luck Next Time...!!!",(SCREEN_WIDTH - metrics3.stringWidth("Game Over...!!!"))/3, SCREEN_HEIGHT/6);
